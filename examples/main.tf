module "multiversx-observer" {
  ...
  instance_name = "mvx-observer-mnt" #name of the LH instance
  ...
  cbs0_disk_size = 400 #disk contains node-0 and node-metachain data
  cbs1_disk_size = 500 #disk contains node-1
